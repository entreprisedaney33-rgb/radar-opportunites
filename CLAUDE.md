...
- **Dépôt de déploiement** : [`entreprisedaney33-rgb/radar-opportunites`](https://github.com/entreprisedaney33-rgb/radar-opportunites)
  (GitHub, **privé**). C'est CE dépôt que Render construit et lance.
...
- **Phase 0 et Phase 1 faites** : pipeline local complet et testé (31 tests,
  aucun appel réseau/modèle dans les tests).
- **Phase 3 (Render réel)** : dépôt de déploiement créé et synchronisé.
  Ressources Render (Postgres + Cron Job) créées le 2026-09-25 — voir
  `ARCHITECTURE.md` pour les URLs et les coûts réels.
